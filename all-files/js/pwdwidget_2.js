...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='form-control' name='"+pwdname+"' placeholder='Enter Password' id='"+this.pwdfieldid+"'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='form-control' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' placeholder='Enter Password'  style='display: none;'>";
